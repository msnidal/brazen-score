...
LINEAR_NODES_1 = 2048
ATTENTION_DIM = (
    512  # this is supposed to be an embeddings dimension, which I think makes sense
)
...
class SelfAttentionStack(nn.Module):
    ...
    def forward(self, x) -> torch.Tensor:
        ...
        attention_out = self.layer_norm(
            out + x
        )  # add and norm at last step. Verify they're not teh same?
...
class PositionalEncoding(nn.Module):
    ...
    def __init__(self, model_dim: int, dropout: float = 0.1, max_len: int = 5000):
        ...
        )  # TODO: make more use of this https://discuss.pytorch.org/t/what-is-the-difference-between-register-buffer-and-register-parameter-of-nn-module/32723/7
...
class BrazenNet(nn.Module):
    def __init__(self, dropout=0.1):
        ...
        self.convolution_stack = nn.Sequential(
            ...
            ConvolutionNet(
                input_channels=96, output_channels=192, kernel_size=3, padding=1
            ),
            ConvolutionNet(
                input_channels=192, output_channels=128, kernel_size=3, padding=1
            ),
            ConvolutionNet(
                input_channels=128,
                output_channels=128,
